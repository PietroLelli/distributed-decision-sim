...
class Order (val idCode: String, var recipes: List<Recipe>, val environment: DistributedDecisionEnvironment<Any>, var priority: Int = 1, var state: State = State.TOBEASSIGNED) {
