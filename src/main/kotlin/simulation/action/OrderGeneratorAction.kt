...
class OrderGeneratorAction (node: Node<Any>, val environment: DistributedDecisionEnvironment<Any>) : AbstractAction<Any>(node) {
    ...
    override fun execute() {
        ...
        val order = OrderGenerator.generateOrder(environment)
